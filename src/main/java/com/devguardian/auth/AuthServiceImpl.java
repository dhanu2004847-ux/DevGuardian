...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponseDTO refreshToken(TokenRefreshRequestDTO dto) {
        // Validate signature/expiry first, then confirm it hasn't been revoked/logged out.
        String email = tokenProvider.validateTokenAndGetEmail(dto.getRefreshToken());
    ...
    public void logout(String token) {
        // Header may arrive as "Bearer <token>" or the raw refresh token.
